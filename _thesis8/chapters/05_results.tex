...
\begin{table}[H]
  ...
  \begin{tabular}{llccccc}
    ...
    \midrule
    1 & B0CB1FW5FC  & Portable Charger   & 0.752 & 0.814 & 1.000 & 0.710 \\
    2 & B0CRTR3PMF  & TWE                & 0.739 & 0.828 & 0.940 & 0.668 \\
    3 & B09DT48V16  & TWE                & 0.735 & 0.795 & 0.960 & 0.682 \\
    4 & B0DGHMNQ5Z  & Gaming Keyboard    & 0.715 & 0.762 & 0.900 & 0.694 \\
    5 & B0DD41G2NZ  & Portable Charger   & 0.710 & 0.780 & 0.880 & 0.720 \\
    \bottomrule
  \end{tabular}
  \caption{Top-5 watchlist ASINs by Brand Momentum Score (latest snapshot). BMS $= 0.5 \times \text{nBSR} + 0.3 \times \text{nRev} + 0.2 \times \text{nSent}$. Rev.\ Vel. is capped at 50 new reviews per day before normalisation. TWE = True Wireless Earbuds.}
  \label{tab:bms_top5}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{llcc}
    ...
    \multirow{5}{*}{Top 5}
      & B0C9ZJHQHM & TWE              & 96.9 \\
      & B0C88CVQTD & Gaming Keyboard  & 96.5 \\
      & B0CZNY9JD1 & Gaming Keyboard  & 96.5 \\
      & B0CQDKQSSJ & Portable Charger & 96.0 \\
      & B0CVG9BQHH & TWE              & 95.5 \\
    \midrule
    \multirow{5}{*}{Bottom 5}
      & B0FQFB8FMG & TWE              & 79.5 \\
      & B0DNJZX7K5 & Portable Charger & 83.0 \\
      & B0BWHM1X3W & Gaming Keyboard  & 85.5 \\
      & B0CG3XVQMN & TWE              & 86.0 \\
      & B09KDT7N9T & Portable Charger & 86.5 \\
    \bottomrule
  \end{tabular}
  \caption{Top-5 and bottom-5 watchlist ASINs by Listing Quality Score (LQS) from the latest snapshot. LQS is scored from 0--100 across seven components: title length, bullet count, image presence, A+ content, star rating, review count, and sentiment. TWE = True Wireless Earbuds.}
  \label{tab:lqs_extremes}
\end{table}

The BMS table confirms that the highest-momentum ASINs are distributed across all three categories rather than concentrated in one. B0CB1FW5FC reached the review-velocity ceiling (normalised score = 1.0, capped at 50 new reviews/day), which is the most influential component after BSR velocity. The LQS extremes table illustrates that even the bottom-scoring ASIN (79.5) is not a weak listing by absolute standards; the differentiation is marginal, consistent with the high-floor observation reported earlier.
