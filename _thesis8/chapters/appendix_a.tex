...
\begin{longtable}{p{0.22\textwidth}@{\hspace{8pt}}p{0.68\textwidth}}
...
\begin{longtable}{p{0.38\textwidth}@{\hspace{8pt}}p{0.52\textwidth}}
  ...
  {\small\texttt{evaluate\_sentiment\_manual.py}} & Produces \texttt{data/eval/sentiment\_manual\_eval.json}; requires a manually labeled \texttt{reviews\_to\_label.csv}. \\
...
\begin{longtable}{p{0.36\textwidth}@{\hspace{8pt}}p{0.54\textwidth}}
  ...
  \texttt{data/eval/sentiment\_manual\_eval.json} & Generated by \texttt{scripts/evaluate\_sentiment\_manual.py}; used for proxy noise quantification and true RoBERTa accuracy against 200 manual labels. See Table~\ref{tab:manual_label_eval}. \\
