...
\citep{openai2023functions}. OpenAI's \texttt{gpt-5.4-mini} model
\citep{openai2026gpt54mini} extends this pattern by optimising
explicitly for subagent and tool-use workloads, making it a practical
choice for constrained agentic delivery systems.
...
forecasts, BMS, LQS, sentiment, and listing-content into action-oriented briefs. This
